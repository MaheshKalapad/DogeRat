...
read -p "6743958619:AAGYUvmnsVY-3vlXAX62LyYJhp4iv7qTAjY: " token
read -p "6695405871: " id
sed -i "s/const token = '6695405871'/const token = '$token'/g" index.js
sed -i "s/const id = '6695405871'/const id = '$id'/g" index.js
